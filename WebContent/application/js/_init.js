...
//----------------------------------
var appliname = 'CJEO';
var karutaname = 'CJEO'; // to share the same 'karuta-core' with multiple front-end
//appliname = '';
//karutaname = '';
...
//serverBCK = '/karuta-backend'+bckname;
//serverBCK_API = serverBCK+"/rest/api";
//----------------------------------
...
//----------------------------------
var technical_support = "karuta@eportfolium.com"; // email of technical support
var demo = false;
var karuta_create_account = false;
//--------- NAVBAR BRAND ------------------ logo 126 x 34
var navbar_title = {};
navbar_title["fr"] = "<img style='height: 60px' src='"+karuta_url+"/application/img/Logo-CJEOutaouais-Hori-transp.png'/>";
//-----------LOGIN PAGE -----------------------
var welcome1 = {};// Welcome title
	welcome1["fr"] = "<img class='img-responsive' src='"+karuta_url+"/application/img/Logo-CJEOutaouais-Hori.jpg'/>";
...
var welcome4 = {};			//  Welcome title
	welcome4["fr"] = "Bienvenue dans <i>CJEO en ligne</i>";
